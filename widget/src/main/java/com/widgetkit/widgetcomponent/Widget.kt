...
enum class SizeType {
    ...
    fun toProto(): com.widgetkit.widgetcomponent.proto.SizeType {
        return when (this) {
            TINY -> com.widgetkit.widgetcomponent.proto.SizeType.SIZE_TYPE_TINY
            SMALL -> com.widgetkit.widgetcomponent.proto.SizeType.SIZE_TYPE_SMALL
            MEDIUM -> com.widgetkit.widgetcomponent.proto.SizeType.SIZE_TYPE_MEDIUM
            MEDIUM_PLUS -> com.widgetkit.widgetcomponent.proto.SizeType.SIZE_TYPE_MEDIUM_PLUS
            LARGE -> com.widgetkit.widgetcomponent.proto.SizeType.SIZE_TYPE_LARGE
            else -> com.widgetkit.widgetcomponent.proto.SizeType.SIZE_TYPE_EXTRA_LARGE
        }
    }
