package com.widgetkit.dsl.widget.render.glance.converter
...
import com.widgetkit.dsl.proto.Color as ProtoColor
...
internal object ColorConverter {
    ...
    fun toGlanceColorProvider(colorProvider: ColorProvider): androidx.glance.unit.ColorProvider {
        ...
        return androidx.glance.unit.ColorProvider(R.color.transparent)
    }

    /**
     * Proto Color를 Compose Color로 변환 (필요한 경우)
     */
    fun toComposeColor(protoColor: ProtoColor): Color {
        return Color(protoColor.argb)
    }
