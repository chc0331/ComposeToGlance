...
import com.widgetkit.dsl.widget.glance.render.GlanceProgress
import com.widgetkit.dsl.widget.remoteviews.RvProgress

internal class ProgressNode : NodeRenderer {
    @Composable
    override fun render(
        node: WidgetNode,
