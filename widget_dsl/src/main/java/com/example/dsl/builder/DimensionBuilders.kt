...
internal fun DimensionDp(value: Float): Dimension = Dimension.newBuilder().setDp(Dp(value)).build()

internal fun DimensionWeight(weight: Float): Dimension =
    Dimension.newBuilder().setWeight(weight).build()
...
internal fun CornerRadius(all: Float): CornerRadius =
    CornerRadius.newBuilder().setRadius(all).build()
