...
internal object GlanceImage : RenderNode {
    ...
    private fun toGlanceContentScale(protoScale: com.widgetkit.dsl.proto.ContentScale): ContentScale {
        return when (protoScale) {
            com.widgetkit.dsl.proto.ContentScale.CONTENT_SCALE_FIT -> ContentScale.Fit
            com.widgetkit.dsl.proto.ContentScale.CONTENT_SCALE_CROP -> ContentScale.Crop
            com.widgetkit.dsl.proto.ContentScale.CONTENT_SCALE_FILL_BOUNDS -> ContentScale.FillBounds
