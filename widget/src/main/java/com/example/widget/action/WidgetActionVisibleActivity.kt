...
import com.example.widget.component.devicecare.StorageCollector
import com.example.widget.component.devicecare.StorageDetailInfo
...
private fun AppStorageItem(
    appInfo: com.example.widget.component.devicecare.AppStorageInfo
) {
    Surface(
        modifier = Modifier.fillMaxWidth(),
