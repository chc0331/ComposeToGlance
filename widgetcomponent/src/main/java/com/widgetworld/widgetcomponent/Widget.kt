...
enum class SizeType {
    ...
    fun toProto(): com.widgetworld.widgetcomponent.proto.SizeType {
        return when (this) {
            TINY -> com.widgetworld.widgetcomponent.proto.SizeType.SIZE_TYPE_TINY
            SMALL -> com.widgetworld.widgetcomponent.proto.SizeType.SIZE_TYPE_SMALL
