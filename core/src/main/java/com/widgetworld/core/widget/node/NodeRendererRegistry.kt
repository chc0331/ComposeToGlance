 ...
 * ```
 */
internal object RenderNodeRegistry {
    /**
     * 노드 타입별 Renderer 매핑
     * 키: 노드 타입 문자열 (예: "box", "text", "image")
     * 값: 해당 타입의 NodeRenderer 구현체
     */
    private val renderers = mutableMapOf<String, RenderNode>()
     ...
     */
    fun register(type: String, renderer: RenderNode) {
     ...
     */
    fun getRenderer(type: String): RenderNode? {
     ...
     */
    fun getRendererForNode(node: WidgetNode): RenderNode? {
